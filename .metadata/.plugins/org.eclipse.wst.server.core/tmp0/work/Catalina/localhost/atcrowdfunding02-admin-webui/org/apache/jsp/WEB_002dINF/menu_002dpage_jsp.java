 ...
 * Generated at: 2022-09-03 02:36:33 UTC
...
public final class menu_002dpage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/modal-menu-add.jsp", Long.valueOf(1662131187415L));
    _jspx_dependants.put("/WEB-INF/modal-menu-edit.jsp", Long.valueOf(1662129848948L));
    ...
    _jspx_dependants.put("/WEB-INF/modal-menu-confirm.jsp", Long.valueOf(1662171861046L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("$(function(){\r\n");
      out.write("	\r\n");
      out.write("	generateTree()//生成树形结构\r\n");
      out.write("	\r\n");
      out.write("	//1.1添加结构的模态框\r\n");
      out.write("	$(\"#treeDemo\").on(\"click\", \".addBtn\", function(){\r\n");
      out.write("		window.pid = this.id//当前节点的id为新增节点的父节点\r\n");
      out.write("		$(\"#menuAddModal\").modal(\"show\")\r\n");
      out.write("		$(\"#menuResetBtn\").click()//重置表单——用于请求空上次数据\r\n");
      out.write("		return false//禁用a连接默认行为\r\n");
      out.write("	})\r\n");
      out.write("	//1.2 添加结构的功能\r\n");
      out.write("	$(\"#menuSaveBtn\").click(function(){\r\n");
      out.write("					\r\n");
      out.write("		var name = $(\"#menuAddModal [name=name]\").val()\r\n");
      out.write("		var url = $(\"#menuAddModal [name=url]\").val()\r\n");
      ...
      out.write("					generateTree()//生成树形结构\r\n");
      out.write("				}\r\n");
      out.write("				if(result == \"FAILD\"){\r\n");
      out.write("					layer.msg(\"操作失败\" + response.message)\r\n");
      out.write("				}\r\n");
      out.write("			},\r\n");
      out.write("			\"error\": function(resopnse){\r\n");
      out.write("				layer.msg(response.status + \" \" + response.message)\r\n");
      out.write("			}\r\n");
      out.write("		})\r\n");
      out.write("	})\r\n");
      out.write("	\r\n");
      out.write("	//2.1 修改结构的模态框\r\n");
      out.write("	$(\"#treeDemo\").on(\"click\", \".editBtn\", function(){\r\n");
      out.write("		window.id = this.id//当前节点的id\r\n");
      out.write("		$(\"#menuEditModal\").modal(\"show\")\r\n");
      out.write("		\r\n");
      out.write("		var zTreeObj = $.fn.zTree.getZTreeObj(\"treeDemo\")//获取zTreeObj对象\r\n");
      out.write("		var key = \"id\"//节点的属性名\r\n");
      out.write("		var value = window.id\r\n");
      out.write("		var currentNode = zTreeObj.getNodeByParam(key, value)//调用zTreeObj的getNodeByParam方法，根据id获取节点数据\r\n");
      out.write("		\r\n");
      out.write("		//回显表单\r\n");
      ...
      out.write("				</button>\r\n");
      out.write("				<h4 class=\"modal-title\">新增节点</h4>\r\n");
      out.write("			</div>\r\n");
      out.write("			<form>\r\n");
      ...
      out.write("					<span aria-hidden=\"true\">&times;</span>\r\n");
      out.write("				</button>\r\n");
      out.write("				<h4 class=\"modal-title\">删除节点</h4>\r\n");
      out.write("			</div>\r\n");
      out.write("			<form>\r\n");
      out.write("				<div class=\"modal-body\">\r\n");
