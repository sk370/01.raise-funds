...
$(function(){
	$("#toRightBtn").click(function(){
		$("select:eq(0)>option:selected").appendTo("select:eq(1)");//添加角色
	})
	$("#toLeftBtn").click(function(){
		$("select:eq(1)>option:selected").appendTo("select:eq(0)");//移除角色
	})
			  ...
			  <div class="panel-body">
				<form action="assign/do/role/assign.html" method="post" role="form" class="form-inline">
				  ...
				  <div class="form-group" style="margin-left:40px;">
                    ...
                    <button id="menuEditBtn" type="submit" class="btn btn-success">提交</button>
				  </div>
				</form>
			  </div>
			</div>
